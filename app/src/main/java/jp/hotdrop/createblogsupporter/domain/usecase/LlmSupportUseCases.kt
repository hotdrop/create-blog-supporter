...
class GenerateSectionPastePromptUseCase @Inject constructor() {
    operator fun invoke(request: SectionConsultationRequest): String =
        buildSectionPastePrompt(request)
}
